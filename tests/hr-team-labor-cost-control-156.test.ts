...
describe("Project Octopus HR labor cost control", () => {
  ...
  it("mounts the current investment labor workspace and keeps quick assignment functional", () => {
    ...
    expect(wrapper).toContain("<HrTeamCostControl156");
    expect(control).toContain('data-hr-labor-cost-control="2"');
    expect(control).toContain('action: "assignment_create"');
    expect(control).toContain("Koszt zatwierdzony");
    expect(control).toContain("Do zatwierdzenia");
