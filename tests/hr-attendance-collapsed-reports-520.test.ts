...
describe("HR attendance list 5.2 collapsed employee registry and period reports", () => {
  it("starts with every employee collapsed and renders an employee table instead of an employee selector", () => {
    expect(component).toContain("useState<Set<string>>(() => new Set())");
  ...
  it("offers annual and arbitrary date-range summaries per employee", () => {
