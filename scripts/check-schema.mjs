...
const checks = [
  ...
  ["documents", "id,workspace_id,project_id,name,category,current_version_id,created_by,created_at,updated_at"],
  [
    "document_versions",
    "id,document_id,project_id,version_number,file_name,mime_type,file_size_bytes,r2_bucket,r2_object_key,sha256,upload_status,uploaded_by,uploaded_at,created_at"
  ],
  ...
  ["project_facts", "id,project_id,fact_type,title,value,confidence,source_reference_id,created_at,updated_at"],
