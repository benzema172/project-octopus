...
export default async function CostEstimatePage({ params }: Props) {
  ...
  return <ProjectModuleFoundation
    ...
    metrics={[
      ...
      { label: "Fakty inwestycji", value: String(knowledge.facts), hint: "dostępne w Octopus Brain" }
    ]}
    documents={documents}
    ...
    principle="Kosztorys jest teraz przetwarzany do strukturalnych danych Brain. Oryginalny plik pozostaje źródłem, a rozpoznane pozycje mogą być używane przez inne moduły bez ponownego przepisywania."
  />;
}
