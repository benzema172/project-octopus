...
export default async function ProjectTeamPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return <ProjectModulePage projectId={projectId} module={PROJECT_MODULES.team} requiredDomain="hr" kind="team"><ProjectOperationPanel projectId={projectId} mode="assignment" /><ProjectLiveRecords projectId={projectId} kind="team" /></ProjectModulePage>;
}
