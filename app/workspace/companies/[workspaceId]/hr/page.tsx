...
import { HrWorkspace146 } from "@/components/company/hr/hr-workspace-146";
...
export default async function HrPage({ params }: { params: Promise<{ workspaceId: string }> }) {
  ...
  return <main className={`co-page ${styles.hr141} ${compact.profile143}`}>
    ...
    <HrWorkspace146 workspaceId={workspace.id} data={data} canWrite={canWrite} canApprove={canApprove} />
  </main>;
}
