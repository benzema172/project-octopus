...
insert into public.app_schema_versions(version) values('20260903_fleet_connected_400_rpc_security') on conflict(version) do update set applied_at=excluded.applied_at;
commit;
