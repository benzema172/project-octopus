...
begin
  ...
  -- Close any previous employee responsibility mirror before changing target.
...
-- Backfill only currently assigned employee-owned instances that are not mirrored yet.
