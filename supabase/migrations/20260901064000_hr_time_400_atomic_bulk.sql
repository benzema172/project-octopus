...
begin
    ...
    foreach v_work_date in array p_dates loop
      ...
      if p_mode = 'replace_single' and v_existing_count = 1 then
        ...
        insert into public.timesheets (
          ...
          p_hours, p_overtime_hours, 'submitted', null, null,
  ...
  insert into public.audit_events (
    ...
    p_workspace_id, p_actor_id, 'user', 'hr.timesheet_bulk_applied', 'timesheet_bulk', gen_random_uuid(),
    jsonb_build_object(
...
revoke all on function public.bulk_apply_hr_timesheets_400(uuid, uuid, uuid[], date[], uuid, numeric, numeric, text) from public;
