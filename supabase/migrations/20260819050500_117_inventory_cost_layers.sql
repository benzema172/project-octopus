...
using (public.has_domain_access(workspace_id,'warehouse','read',null) or public.has_domain_access(workspace_id,'finance','read',null));
...
create index if not exists inventory_consumptions_project_idx
  on public.inventory_consumptions(workspace_id,project_id,created_at desc);
