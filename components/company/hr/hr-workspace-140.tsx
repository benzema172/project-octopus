...
export function HrWorkspace140({ workspaceId, data, canWrite, canApprove, canViewPayroll, canManagePayroll, activeTab, onTabChange, hiddenTabs = [] }: HrWorkspace140Props) {
  ...
  const content = hiddenTabs.includes(tab) ? null : tab === "dashboard" ? dashboard : tab === "employees" ? employeeTab : tab === "time" ? timeTab : tab === "leaves" ? leavesTab : tab === "compliance" ? complianceTab : tab === "teams" ? teamsTab : documentsTab;
