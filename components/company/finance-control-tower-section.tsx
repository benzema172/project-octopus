...
export async function FinanceControlTowerSection({ workspaceId }: { workspaceId: string }) {
  ...
  return <FinanceControlTower workspaceId={workspace.id} data={data} canWrite={canWrite} canApprove={canApprove} />;
}
